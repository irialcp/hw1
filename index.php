...
<head>
    ...
    <script src="js/header.js" defer></script> <script src="js/index.js" defer></script>  
</head>
...
<body class="<?php echo $body_class; ?>">
    ...
    <main>
        ...
        <section class="cta-buttons-section">
            ...
            <a href="team.php" class="cta-button">Team</a>
        </section>
        ...
        <section id="info-section">
            ...
            <div id="info-image">
                <img src="public/info.png" alt="Informazioni">
            </div>
        </section>
